...
<div class="container">
    ...
    <form enctype="multipart/form-data" data-toggle="validator" class="form-horizontal task_form" id="myForm" role="form" name="myForm" method="post">
    ...
    <div class="avatarInfoWrapper">   
        ...
        <div class="form-group avatarInfoItem">
            ...
            <div class="col-xs-8">
                <input class="form-control" type="text" id="fullname" name="fullname" required placeholder="请输入真实姓名，如：张三">
            </div>
        </div>
        <div class="form-group avatarInfoItem">
...
<!--        <div class="form-group avatarInfoItem">
		...
		<?php echo $account['phone'];?>
                <input class="form-control" type="hidden" name="contactPhone" value="<?php echo $account['phone'];?>">
            </div>
        </div>
    </div>
    ...
    <div class="row photoWrapper">
     ...
     <div class="row uploadText" style="margin:0 -25px;">
      ...
      <div class="row split" style="height:80px">
		...
		<span style="font-size:12px">同意并接受<a><自由快递人注册协议></a></span></div>
...
<!-- Modal -->
    <div id="provinceModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
