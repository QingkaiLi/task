...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="color:black;" href="#">筋斗云
                <small style="color:#337ab7;">快递员认证</small>
            </a>
        </div>
...
<tr>
    <td>
        <button class="btn btn-primary" data={{>openid}} type="button" style="height:20px;padding-top:2px;">
            <i class="fa fa-check"></i>
        </button>
    </td>
	<td>
	    <a data-toggle="modal" href="applier_detail_page.php?openid={{>openid}}" data-target="#detailModal">{{>fullname}}</a>
    </td>
