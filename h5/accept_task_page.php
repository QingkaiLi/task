...
<div class="container">
    <form class="form-horizontal" role="form" name="myform" method="post" action="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="ui-input easyui-validatebox" data-options="required:true,validType:'mobile'"
                       id="acceptPhone" name="acceptPhone"/>
            </div>
        </div>
        <div class="form-group">
            <!-- Text input-->
            ...
            <div class="col-sm-10">
                <input type="text" class="ui-input easyui-validatebox" data-options="required:true" id="verifyCode"
                       name="verifyCode"/>
