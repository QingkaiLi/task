    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="color:black;" href="#">筋斗云
                <small style="color:#337ab7;">任务管理</small>
            </a>
        </div>
...
<tr>
    <td>
        <button class="btn btn-primary" data={{>id}} type="button" style="height:20px;padding-top:2px;">
            <i class="fa fa-remove"></i>
        </button>
    </td>
	<td>
	    <a data-toggle="modal" href="task_view_page.php?task={{>id}}?type=-1" data-target="#detailModal">{{>title}}</a>
    </td>
