...
<div class="container">
    ...
    <form data-toggle="validator" class="form-horizontal task_form" role="form" name="myform" method="post" action="">
        ...
        <div class="form-group">
            <!-- Text input-->
            <label class="col-sm-2 col-xs-4 control-label" for="endTime">送达时间:
                <!--<span class="requiredIco pull-right">*</span>--></label>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 col-xs-8 input-group">
                ...
                <a id="mapMarker" class="position input-group-addon"><span
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-10 input-group" style="width:120px;">
                <input type="text" placeholder="金额" class="form-control" id="tip" name="tip"
    ...
    <div class="form-group" style="margin-top:35px;">-->
        ...
        <div class="form-group">
            <!-- Text input-->
            <label class="col-sm-2 col-xs-4 control-label" for="address">联系方式:<span
                    class="requiredIco pull-right">*</span></label>

            <div class="col-xs-8 col-sm-10">
                <input type="text" placeholder="" class="form-control" id="phone" name="phone" pattern="^1\d{10}$"
                       required/>
            </div>
        </div>
...
<div id="calenderModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
